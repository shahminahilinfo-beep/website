...
export default function Hero(): JSX.Element {
  ...
  // NOTE: framer-motion: triggerOnce => once
  ...
  return (
    <>
      {" "}
      <main className="w-full relative h-full lg:h-[800px] bg-no-repeat flex items-center justify-center bg-[#140b1c]">
        {/* Glows */}
        ...
        <section className="relative container w-full mx-auto h-full flex flex-col md:flex-row items-center justify-between px-4 md:px-8 xl:px-12 py-16 md:py-32 ">
          ...
          >
            ...
            <p className="text-base md:text-lg 2xl:text-xl max-w-2xl font-lato">
              At Robx.ai, we help businesses grow with smart AI tools, easy to
              use websites, and helpful chatbots. Our team focuses on
              understanding your needs and building solutions that save time,
              work smoothly, and deliver real results.
            </p>
          ...
          >
            <Image
              src="/about/hero/About-Hero-5.png"
              alt="AI Bot Graphic"
